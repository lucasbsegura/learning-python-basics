...
# arguments (3 or more) The foo function must return the amount of extra arguments 
# received. The bar must return True if the argument with the keyword magicnumber 
